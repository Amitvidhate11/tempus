...
const AI_AGENTS: Agent[] = [
  {
    ...
    role: "Tempus Assistant",
    avatar: "/ai-support-final.png",
    status: "online",
    icon: Sparkles,
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="w-[380px] overflow-hidden rounded-2xl border border-border/40 bg-background shadow-2xl backdrop-blur-xl ring-1 ring-white/10 pointer-events-auto"
          >
            {/* Header */}
            ...
            <div className="flex h-[320px] flex-col gap-4 overflow-y-auto p-4 bg-gradient-to-b from-background/20 to-background/40">
              <motion.div variants={messageVariants} className="flex gap-3">
                <Avatar className="h-8 w-8 border border-border/40 shadow-sm">
                  <AvatarImage src={currentAgent.avatar} className="object-cover object-top" />
              ...
              >
                ...
                <div className="flex max-w-[85%] flex-col items-end gap-1">
                  <div className="rounded-2xl rounded-tr-none bg-primary px-4 py-2.5 text-sm text-primary-foreground shadow-md">
                    <p>I need help with my campus scheduling.</p>
                  </div>
                </div>
              </motion.div>
